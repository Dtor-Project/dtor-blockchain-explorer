...
namespace xmreg
{
    ...
    CmdLineOptions::CmdLineOptions(int acc, const char *avv[]) {
        ...
        options_description desc(
                "xmrblocks, Onion Dtor Blockchain Explorer");
        ...
        desc.add_options()
                ...
                ("enable-emission-monitor", value<bool>()->default_value(false)->implicit_value(true),
                 "enable Dtor total emission monitoring thread")
                ...
                ("bc-path,b", value<string>(),
                 "path to lmdb folder of the blockchain, e.g., ~/.dtor/lmdb")
                ...
                ("deamon-url,d", value<string>()->default_value("http:://127.0.0.1:23468"),
                 "Dtor daemon url");
