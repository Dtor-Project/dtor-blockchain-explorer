...
main(int ac, const char* av[])
{
    ...
    if (testnet && deamon_url == "http:://127.0.0.1:23468")
        deamon_url = "http:://127.0.0.1:33468";
    if (stagenet && deamon_url == "http:://127.0.0.1:23468")
        deamon_url = "http:://127.0.0.1:43468";
    ...
    ([&](const crow::request& req) -> myxmr::htmlresponse
     {
        ...
        {
            return string("dtor address, viewkey or tx hash not provided");
        }
        ...
        ([&](const crow::request& req) -> myxmr::htmlresponse 
         {
            ...
            {
                return string("dtor address, tx private key or "
